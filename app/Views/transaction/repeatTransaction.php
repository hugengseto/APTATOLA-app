...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Repeat Transaction</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/transaction">Transaction</a></li>
                        <li class="breadcrumb-item"><a href="/transaction/create">New Transaction</a></li>
                        <li class="breadcrumb-item active">Repeat Transaction</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <small>Please fill out this form to add a repeat transaction</small>
                        ...
                        <div class="card-body">
                            <form action="/transaction/save" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?= session('errors') && isset(session('errors')['customer_name']) ? 'is-invalid' : ''; ?>" id="customer_name" name="customer_name" value="<?= old('customer_name', $customer[0]['customer_name']); ?>" readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?= session('errors') && isset(session('errors')['customer_whatsapp']) ? 'is-invalid' : ''; ?>" id="customer_whatsapp" name="customer_whatsapp" value="<?= old('customer_whatsapp',  $customer[0]['customer_whatsapp']); ?>" readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control laundry-package select2bs4 <?= session('errors') && isset(session('errors')['package']) ? 'is-invalid' : ''; ?>" name="package" autofocus>
